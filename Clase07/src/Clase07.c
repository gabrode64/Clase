...
char imprimirArrayString(char aNombres[][QTY_CARACTERES],int limite )
{
	int i;
	int retorno = -1;
	if(aNombres != NULL && limite > 0)
	{
		retorno = 0;
		for(i=0;i<limite;i++)
		{
...
int main(void)
{
	...
	//cantidadDatos = getArrayInt(edadesEmpleados,
	//QTY_EMPLEADOS,"Edad?\n","Error\n",0,200,2);
	/*if(cantidadDatos > 0)
	{
